...
- Users looking to utilize tools such as [Singularity](https://singularity.lbl.gov/), or other virtualization systems to containerize workflows in the HPC (high-performance computing) clusters.
...
- A quintessential example of an entity that would not be a user could be a team working with limited data and non-complex algorithms that might be better suited on AWS/GCP.
